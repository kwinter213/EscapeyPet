...
class Coin(pg.sprite.Sprite):
    ...
    def setup_frames(self):
        ...
        self.frames.append(self.get_image(521, 196, 63, 63))
        self.frames.append(self.get_image(260, 401, 64, 53))
        self.frames.append(self.get_image(783, 200, 59, 59))
        self.frames.append(self.get_image(994, 846, 27, 63))
